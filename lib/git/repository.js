...
class Repository {
  ...
  read_rec() {
    ...
    return redis_client.hgetallAsync(key);
  }
  ...
  write_rec(/*patch*/) {
    ...
    return Promise
            .try(() => {
              ...
              return redis_client.hmsetAsync(key, arr);
            });
  }
  ...
  read_acl(options = {}) {
    ...
    return redis_client.hgetAsync(key, `acl.${token}`);
  }
  ...
  write_acl(options = {}) {
    ...
    return redis_client.hsetAsync(key, `acl.${token}`, true);
  }
                ...
                this.p = Promise
                          ...
                          .then((repo) => {
                            return Promise
                                    ...
                                    .then(() => {
                                      // todo [akamel] use new mechanics to find 'master' branch for repo
                          ...
                          .catch((err) => {
                            ...
                            throw new Error('not found', this.remote());
                          })
                          .finally(() => {
                            delete this.p;
                          });
    ...
    return repo
            ...
            .then((arr) => {
              ...
              return repo
                      .pull({ token })
                      .then(() => {
                        winston.info('pull_use_acl_rec', repo.remote(), token, arr);
                      })
                      .catch(() => {
                        winston.error('pull_use_acl_rec', repo.remote(), token, arr);
                      });
            });
  }
