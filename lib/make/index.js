...
var Promise     = require('bluebird')
  ...
  , tailf_sdk   = require('tailf.io-sdk')
  ;
  ...
  stream(repository, stream, options = {}) {
    ...
    return Promise
            ...
            .then(() => {
              ...
              let tailf               = new (tailf_sdk.Producer)()
                , { stdout, stderr }  = tailf.streams()
                ;

              let t = tailf.uri().then((uri) => winston.info('make:stream tailf', repository.remote(), uri));
